  ...
  return (
    <aside className="hidden md:flex flex-col w-64 shrink-0 p-5 pr-0">
      <div className="flex flex-col h-full bg-background rounded-[24px] border border-border/60 p-5">
        <Link href="/seller/dashboard" className="flex items-center gap-2.5 px-1">
        ...
        <div className="mt-auto pt-4 border-t border-border/60 space-y-1">
          <Link href={`/${store.slug}`} className="flex items-center gap-2 px-3 h-9 rounded-full text-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
            <ExternalLink className="h-4 w-4" /> View store
          </Link>
          <Link href="/seller/login" className="flex items-center gap-2 px-3 h-9 rounded-full text-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
