...
import { stats, orders, formatNGN, store } from "@/lib/mock-data";
...
export default function SellerDashboardPage() {
  ...
  useEffect(() => { setOnboarded(true); }, []);

  if (onboarded === null) return null;
  if (!onboarded) { router.push("/seller/onboarding"); return null; }
      ...
      <SellerLayout>
        ...
        <div className="p-4 md:p-7 space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard label="Total Sales" value={formatNGN(stats.totalSales)} icon={DollarSign} accent="primary" trend="+18%" />
            <StatCard label="Total Orders" value={String(stats.totalOrders)} icon={ShoppingBag} accent="warning" trend="+12" />
