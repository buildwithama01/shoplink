    ...
    <div className="min-h-screen bg-canvas grid lg:grid-cols-2">
        ...
        <div className="flex-1 rounded-[28px] bg-ink text-ink-foreground p-12 flex flex-col justify-between">
          ...
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight leading-tight max-w-md">
              Start selling to anyone, anywhere with a single link.
            </h2>
          </div>
      ...
      <div className="flex items-center justify-center p-5">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8">
            <Button 
              className="w-full flex items-center justify-center gap-2 bg-background border border-border text-foreground hover:bg-muted" 
              size="lg" 
              type="button"
          ...
          {/* <p className="mt-6 text-center text-xs text-muted-foreground">
            New here?{" "}
            <Link href="/seller/onboarding" className="underline hover:text-foreground">
              Create your store
            </Link>
          </p> */}
        </div>
