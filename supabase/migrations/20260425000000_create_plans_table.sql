...
VALUES 
('Free', 'Perfect to get started', 0, 20, 10, ARRAY['1 store', 'Up to 10 products', 'WhatsApp order alerts', 'Customer order tracking', 'Kozura subdomain'], false, 'bg-slate-500/10 dark:bg-slate-500/20'),
